...
public class BaseTest {
   ...
   public void setPostresponse(String postbody, String parampath){
       ...
       System.out.println("POST Status Code: " + getresponse.getStatusCode());
       System.out.println("POST Response: " + getresponse.getBody().prettyPrint());
   ...
   public void setPutresponse(String putbody, String parampath){
       ...
       System.out.println("PUT Status Code: " + getresponse.getStatusCode());
       System.out.println("PUT Response: " + getresponse.getBody().prettyPrint());
   }
   ...
   public void setPatchresponse(String patchebody, String parampath){
       ...
       System.out.println("PATCH Status Code: " + getresponse.getStatusCode());
       System.out.println("PATCH Response: " + getresponse.getBody().prettyPrint());
   }
   public void setDeleteresponse(String parampath){
       deleteresponse=RestAssured.given().delete(parampath);
       System.out.println("DELETE Status Code: " + getresponse.getStatusCode());
       System.out.println("DELETE Response: " + getresponse.getBody().prettyPrint());
   }
